            ...
            <div class="p-5">
                ...
                <div class="mb-7 text-center">
                    ...
                    <p class="mt-2 text-sm leading-4 text-slate-600">
                        Debes ingresar para realizar esta acción.
                    </p>
                </div>
                <div>
                    ...
                    <div class="flex w-full items-center gap-2 py-6 text-sm text-slate-600">
                        <div class="h-px w-full bg-slate-200"></div>O
                ...
                <div class="mt-6 text-center text-sm text-slate-600">
                    ¿No tienes una cuenta? <a href="/dashboard" class="font-medium text-[#4285f4]"> Registrar</a> </div>
            </div>
        </div>
    </div>
</div>
